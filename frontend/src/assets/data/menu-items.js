export const MENU_ITEMS = [
  ...
  // ── Website Apps ──────────────────────────────────────────────────────────
  {
    ...
    permissions: ['websiteLeads.manage', 'newsletterSubscribers.view'],
  },
  {
    key: 'website-leads',
  ...
  // ── Website Utilities ─────────────────────────────────────────────────────
  {
    ...
    permissions: ['products.manage', 'blogs.manage', 'seoMeta.manage', 'landingPage.manage'],
  },
  {
    key: 'products',
  ...
  },
  {
    ...
    permissions: ['products.manage'],
    children: [
      { key: 'orders-all', label: 'All Orders', url: '/ecommerce/orders', parentKey: 'orders' },
      { key: 'orders-confirmed', label: 'Confirmed & Paid Orders', url: '/ecommerce/orders/confirmed', parentKey: 'orders' },
      { key: 'orders-failed', label: 'Failed Orders', url: '/ecommerce/orders/failed', parentKey: 'orders' },
      { key: 'orders-lookup', label: 'Past Order Lookup', url: '/ecommerce/orders/lookup', parentKey: 'orders' },
    ],
  },
  {
    key: 'coupons',
